...
('10000000-0000-0000-0000-00000000010', 'SMMS-010', 'SMMS', 'SIGNAL_TELECOM', 'SIG-180', 'Point Machine Calibration', 'SEC-NDLS-AGC-01', 180.00, 'HIGH', 80, 45, 'TRAFFIC_BLOCK', ARRAY['SIGNAL_MEMO'], 'PENDING')
ON CONFLICT (id) DO NOTHING;
